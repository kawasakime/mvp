...
window.addEventListener('DOMContentLoaded', function() {
    const dataBaseProducts = {
        ...
        21: {
            sale: 'n',
            name: 'ELARI SmartBot Brush',
            description: 'Используя робота-пылесоса ELARI SmartBot Brush, вы сможете провести качественную уборку, не тратя много времени и сил. Данная модель поможет справиться не только с влажной, но и с сухой уборкой, а одного заряда хватит на 120 минут непрерывной работы. Вы сможете управлять пылесосом при помощи голоса. За счет своего компактного размера и наличия боковых щеток прибор проникнет даже в самые труднодоступные места. Современные технологии, высококачественные материалы и профессиональная сборка гарантируют долгий срок службы без поломок. Робот-пылесос ELARI SmartBot Brush очень прост в работе, для этого не требуется специальных знаний, а вся необходимая информация находится в инструкции по применению. Помимо этого, в комплекте предусмотрена сменная насадка.',
            nowPrice: '7 840',
            imgs: ['1.jpg', '2.jpg', '3.jpg'],
            type: 'dry'
        },
        22: {
            sale: 'n',
            name: 'Xiaomi Mi Robot Vacuum Mop Essential',
            description: 'Справиться быстро, а главное качественно с уборкой вам поможет робот-пылесос XIAOMI Mi Robot Vacuum Mop Essential, при этом вам не придется прилагать больших усилий. Устройство способно выполнять как сухую, так и влажную уборку, для сбора пыли имеется специальный контейнер объемом 0,6 л. Также имеется бак для чистой воды, его объем всего лишь 0,2 л. Мощность аксессуара составляет 25 Вт. На корпусе робота-пылесоса XIAOMI Mi Robot Vacuum Mop Essential имеется удобный регулятор, при помощи которого вы сможете изменять мощность в зависимости от ваших потребностей. Защитить устройство от падений и повреждений помогают датчики препятствий и перепада высот. Вы можете запрограммировать устройство на определенный график уборки. Работает робот от литий-ионного аккумулятора емкостью 2500 мАч.',
            nowPrice: '15 990',
            imgs: ['1.jpg', '2.jpg', '3.jpg'],
            type: 'dry'
        },
        23: {
            ...
            description: 'DEEBOT N8 PRO это робот-пылесос, оборудованный технологией OZMO™ для одновременной сухой и влажной чистки напольных покрытий. Благодаря новейшей технологии ТруМаппинг он может составлять подробную и точную карту напольных покрытий. В сочетании с технологией обнаружения препятствий ТруДетект 3D риск застревания сводится к минимуму. Это делает DEEBOT самым подходящим и умным решением для чистки напольных покрытий. Робот-пылесос с функцией влажной уборки обеспечивает более тщательный процесс уборки с обнаружением ковровых покрытий для повышения мощности всасывания по необходимости и предотвращения случайной влажной уборки ковров.',
            nowPrice: '34 800',
            imgs: ['1.jpg', '2.jpg', '3.jpg'],
            type: 'dry'
        }
