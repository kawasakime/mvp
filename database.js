...
window.addEventListener('DOMContentLoaded', function() {
    const dataBaseProducts = {
        ...
        21: {
            sale: 'n',
            name: 'Kitfort КТ-532',
            description: 'Робот-пылесос Kitfort КТ-532 способен не только эффективно удалять сухие частицы загрязнений с поверхностей разных типов, но и в автоматическом режиме проводить влажную уборку помещения. Модель оснащена встроенным аккумулятором емкостью 2000 мА*ч, обеспечивающим возможность функционирования на протяжении 90 минут без необходимости подключения к электрической сети. Для сбора мусора экспертами бренда предусмотрено наличие специального пластикового контейнера с крышкой, объем которого составляет 0,4 л. Управление работой устройства осуществляется с помощью соответствующего беспроводного пульта либо посредством сенсорной панели с кнопками.',
            nowPrice: '9 500',
            imgs: ['1.webp', '2.webp', '3.webp'],
            type: 'wet'
        },
        22: {
            sale: 'n',
            name: 'Kitfort KT-519-4',
            description: 'Пылесос-робот Kitfort KT-519-4 в круглом бело-коричневом корпусе возьмет на себя все обязанности по выполнению сухой уборки на полу. Представленная модель обладает собственным литиево-ионным аккумулятором, рассчитанным на 2.5 часа автономной работы, мощностью всасывания в 20 Вт и ИК-датчиком. В совокупности все это позволяет роботу-пылесосу выполнять уборку самостоятельно, даже в отсутствие владельца. Также у прибора имеется возможность выполнять уборку по расписанию по заранее запрограммированному владельцем графику. Показатель потребляемой мощности модели составляет 20 Вт, что является минимумом среди подобных приборов.',
            nowPrice: '11 990',
            imgs: ['1.jpg', '2.jpg', '3.jpg'],
            type: 'dry'
        }
